...
{
    cout << "\n\nPress a key to return to Transactions Menue...";
    system("pause>0");
...
void PerformTransactionsMenueOption(vector <sClient>& vClients, enTransactionsMenueOption Option)
{
    ...
    case enMainMenue :
        ...
        ShowMainMenue(vClients);
        break;
    default: GoBackToTransactionsMenue(vClients); break;
    }
}
...
void ShowTransactionsMenueScreen(vector <sClient>& vClients)
{
    ...
    PerformTransactionsMenueOption(vClients, ReadTransactionsMenueOption());
}
