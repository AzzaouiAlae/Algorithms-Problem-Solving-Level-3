...
void SumMatrixRowsInArr(int RandomMatrix[3][3], int ArrSumMatrixRows[3], short Rows, short Colms)
{    
    for (int i = 0; i < Colms; i++)
    {        
...
void PrintSumMatrix(int RandomMatrix[3][3], int ArrSumMatrixRows[3], short Rows, short Colms)
{
    for (int i = 0; i < Rows; i++)
        cout << "Row " << i + 1 << " Sum = " << ArrSumMatrixRows[i] << endl;
}
...
int main()
{
    ...
    int RandomMatrix[3][3], ArrSumMatrixRows[3];
    ...
    SumMatrixRowsInArr(RandomMatrix, ArrSumMatrixRows, 3, 3);

    PrintSumMatrix(RandomMatrix, ArrSumMatrixRows, 3, 3);
